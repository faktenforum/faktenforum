...
import { OnClaimStatusUpdatedRequest, BlockMessageRequest } from "~/models";

import { EnvService, MatrixService, SpaceNames } from "~/services";
...
export class ChatActionController {
  ...
  @Tags("Webhooks") // Use Tags with multiple arguments
